// src/components/InviteDriverPanel.jsx — replaces driver self-signup: a
...
import { inviteDriver, resetDriverPin, fetchUnassignedVehicles, fetchDrivers } from '../utils/api';
...
export default function InviteDriverPanel() {
    ...
    const handleResetPin = async (driverId) => {
        setResetMsg(null);
    ...
    return (
        <div className="space-y-4">
            <div className="bg-panel border border-line/10 p-4 rounded-md text-paper space-y-3 font-mono text-[11px]">
                ...
                <form onSubmit={handleInvite} className="bg-ink/60 p-3.5 rounded border border-line/10 space-y-2.5">
