...
const card = {
    ...
    base_fare_rwf: '8000.00', per_km_rwf: '700.00', per_km_long_rwf: '80.00',
    per_kg_rwf: '8.0000', minimum_fare_rwf: '15000.00',
    fuel_litres_per_100km: '10.00', diesel_price_rwf_per_litre: '2927.00',
    ...
    platform_minimum_fee_rwf: '500.00', detention_free_minutes: 60,
    detention_per_hour_rwf: '3800.00',
...
describe('RateCardPanel', () => {
    ...
    it('sends only what actually changed', async () => {
        ...
        expect(changes).toEqual({ diesel_price_rwf_per_litre: 3200 });
    });
