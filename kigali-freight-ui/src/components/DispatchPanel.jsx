  ...
  return (
    <div className="bg-panel border border-line/10 p-3 rounded-md space-y-2">
      ...
      <button
        ...
        className={`w-full flex items-center justify-center gap-2 py-2 rounded font-mono text-[11px] font-bold uppercase tracking-wide transition-colors ${dispatchTargetMode ? 'bg-tarp text-ink' : 'bg-ink text-steel border border-line/15 hover:text-paper'}`}
      >
